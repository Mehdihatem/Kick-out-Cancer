  ...
  return (
    <section id="team" className="py-24 scroll-mt-28">
      ...
      <p className="mx-auto mb-16 max-w-4xl text-center text-lg leading-relaxed">
        Kick Out Cancer est une association loi 1901 créée par des chercheurs, oncologues et pharmaciens — tous sportifs — pour transformer le mouvement en accélérateur de recherche et de prévention contre le cancer.
      </p>
